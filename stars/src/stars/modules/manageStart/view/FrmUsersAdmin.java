...
public class FrmUsersAdmin extends javax.swing.JFrame {
    public static TableRowSorter<TableModel> sorter = new TableRowSorter<TableModel>(new MSTableModelUsers());
    ...
    public FrmUsersAdmin() {
        ...
        TABLA.setModel( new MSTableModelUsers() );
        ((MSTableModelUsers)TABLA.getModel()).cargar();
